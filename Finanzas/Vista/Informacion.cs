...
namespace Finanzas.Vista
{
    partial class Informacion: Form
    {
        public Informacion ()
        {
            ...
            this.labelProductName.Text = "FERRISIS";//AssemblyProduct;
            this.labelVersion.Text = String.Format("Versión {0}", AssemblyVersion);
            this.labelCopyright.Text = AssemblyCopyright;
            this.labelCompanyName.Text = AssemblyCompany;
            this.textBoxDescription.Text = "Es un sistema que realiza el análisis financiero de la empresa FERRISIS (Ferretería) \n" +
